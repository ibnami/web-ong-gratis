...
## Cómo publicar la página web de tu ONG en 3 pasos

### Paso 1: Hacer una copia (Fork)
Haz clic en el botón **`Fork`** (Arriba a la derecha) para copiar este proyecto a tu propia cuenta de GitHub.

### Paso 2: Editar el contenido
1. Abre el archivo `index.html` dentro de tu repositorio.
2. Haz clic en el ícono del **lápiz (Edit file)**.
3. Cambia los textos de ejemplo (nombre de tu ONG, historia, números de cuenta para donativos y contacto) por los datos reales de tu organización.
4. Haz clic en **"Commit changes..."** para guardar los cambios.

### Paso 3: Activar la página pública
1. Ve a la pestaña **`Settings`** de tu repositorio.
2. En el menú izquierdo, entra a **`Pages`**.
3. En la sección *Branch*, selecciona **`main`** y haz clic en **`Save`**.
4. ¡Listo! En 2 minutos Google y tus donantes podrán ver tu página web en el enlace generado.
...
**DevOps Engineer | M.Ed.** | [LinkedIn](https://www.linkedin.com/in/miguelangelibarranavarro) | [GitHub](https://github.com/ibnami)
